<template>
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="max-w-md w-full lg:w-2/3 py-6 px-3">
                ...
                <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                    ...
                    <div class="flex justify-center">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex">
                                <p class="uppercase text-sm font-bold text-gray-700 mr-2">Casa rural</p>
                            ...
                            <div class="flex items-center">
                                <p class="text-3xl text-gray-900">3.000€</p>
                            </div>

                        </div>

                        <div class="relative ml-11 px-5 py-1 font-semibold text-blue-900 leading-tight flex items-center">
                            <p class="absolute inset-0 bg-blue-100 rounded-full mt-7 h-8"></p>
                            <span class="relative">9.8 - Excelente</span>
                        </div>

                    </div>

                    <div class="p-4 border-t border-gray-300 text-gray-700 text-center space-x-6">
                        ...
                        <div class="flex-1 inline-flex items-center">
                            ...
                            <p><span class="text-gray-900 font-bold">6</span> Dormitorios</p>
                        </div>
                        ...
                        <div class="flex-1 inline-flex items-center">
                            ...
                            <p><span class="text-gray-900 font-bold">6</span> Baños</p>
                        </div>
