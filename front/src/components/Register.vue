            ...
            <div class="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div class="relative bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <div>
                            <RouterLink to="/" class="text-white p-1"><img src="../assets/t.png" class="w-20 m-auto" alt="logo"></RouterLink>
                            <h1 class="text-2xl font-semibold text-center pr-28 pl-28">Regístrate</h1>
                        </div>
                        ...
                        <div class="divide-y divide-gray-200">
                            ...
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div class="relative">
                                    <input autocomplete="off" id="confirmpassword" name="confirmpassword" type="confirmpassword" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Confirm password" />
